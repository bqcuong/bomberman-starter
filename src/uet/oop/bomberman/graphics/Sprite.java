...
public class Sprite {
	...
	public static Sprite movingSprite(Sprite normal, Sprite x1, Sprite x2, long animate, long time) {
	...
	public static Sprite movingSprite(Sprite x1, Sprite x2, long animate, long time) {
		long diff = time / 2;
		return (animate % time > diff) ? x1 : x2;
	}
